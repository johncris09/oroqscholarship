...
<body>
	...
	?>
		<table id="table" >
			...
			<tr> 
				<td colspan="8"></td>  
				<td colspan="4" class="text-size-11 text-bold">For the period: 1st Semester of <?php echo $_GET['school_year']; ?></td>
				<td></td>
			</tr>
			...
			<tr class="text-size-11"> 
				...
				<td colspan="12">We hereby acknowledge to have received from MR. ROEL T. VISITACION, City Treasurer, the sum herein specified
					...
					Grant (Senior High School) for the FIRST SEMESTER of SY 2022-2023, the correctness of which we hereby severally certify.</td>  
			</tr> 
			...
			?> 	
						<tr class="text-size-11 table-data"> 
							<td class="text-right"><?php echo $blank_row; ?></td>
							<td></td>
			...
			<!-- <tr class="text-size-11 text-italic">
				<td colspan="13">Attachments:  (1) CAFOA (2)List of Approved Scholarship Applicants for the 1st Semester of SY 2022-2023 (3) Barangay Clearances (4)Certificates of Indigency(5) Certificates of Enrolment</td>    
			</tr> -->
		</table>
		<p class="text-size-11 text-italic">Attachments:  (1) CAFOA (2)List of Approved Scholarship Applicants for the 1st Semester of SY 2022-2023 (3) Barangay Clearances (4)Certificates of Indigency(5) Certificates of Enrolment</p>
		<br> 
	<?php
		}
	?>
