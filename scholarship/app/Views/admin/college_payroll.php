...
<body>
	...
	?>
		<table id="table" >
			...
			<tr class="text-size-11"> 
				...
				<td colspan="12">We hereby acknowledge to have received from MR. ROEL T. VISITACION, City Treasurer, the sum herein specified
					...
					SEMESTER of <?php echo $school_year; ?>, the correctness of which we hereby severally certify.</td>  
			</tr> 
		...
		<p class="text-size-11 text-italic">Attachments:  (1) CAFOA (2)List of Approved Scholarship Applicants for the <?php echo $sem ?> Semester of  <?php echo str_replace("SY: ", "", $school_year)  ?> (3) Barangay Clearances (4)Certificates of Indigency(5) Certificates of Enrolment</p>
		<br> 
	<?php
		}
	?>
