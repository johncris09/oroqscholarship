    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="tvet-course-table" class="table table-striped dt-responsive nowrap w-100">
                        <thead>
                            <tr> 
                                <th>Action</th> 
                                <th>Course</th> 
    ...
    <div class="modal fade" id="add-new-course-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="add-new-tvet-course-form" class="validation-form">
...
<?= $this->section('pageScript') ?>
    ...
    <script>
        $(document).ready(function() { 
            ...
            var table = $('#tvet-course-table').DataTable({
                "scrollY"  : 450,
                "scrollX"  : true, 
                deferRender: true, 
                ajax       : {
                    url: 'tvet_course/get_all',  
                }, 
                columns    : [ 
                    { data: 'id' },  
                    { data: 'course' },  
                            ...
                            action     = '\
                                    <div class="btn-group">\
                                        ...
                                        <div class="dropdown-menu">\
                                            <a data-id="'+row.id+'" class="dropdown-item text-warning" href="#" id="edit-tvet-course-button">\
            ...
            $(document).on('submit', '#add-new-tvet-course-form', function(e){ 
                e.preventDefault();    
                var _this = $(this)
                $.ajax({
                    url     : 'tvet_course/insert',
                    method  : "post", 
                    data    : $("#add-new-tvet-course-form").serialize(),
                    dataType: "json", 
                    ...
                    success : function (data) {  
                        if(data.response){ 
                            ...
                            table.ajax.reload()
                            $("#add-new-tvet-course-form")[0].reset()
            ...
            $(document).on('click', '#edit-tvet-course-button', function(e){ 
                e.preventDefault(); 
                $('#edit-course-modal').modal('show') 

                var id = $(this).data('id') 
                $.ajax({
                    url     : 'tvet_course/get/' + id,
                    method  : "get",
                    dataType: "json", 
                    success : function (data) {
