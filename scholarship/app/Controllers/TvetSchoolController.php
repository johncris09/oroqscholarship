...
class TvetSchoolController extends BaseController
{
    ...
    {
        $data["page_title"] = "TVET School";
        return view('admin/tvet_school', $data);
    }

    public function get_all()
    {
        $school       = new TvetSchoolModel();
    ...
    public function insert()
    {
        try {
            ...
            $activity_model->addLog(auth()->user()->id, 'Created a new tvet school name (\''.$school_name.'\')');
    ...
    public function update()
    {
        try {
            ...
            $activity_model = new UserActivityModel();
            $school_name = $data['school_name'];
            $activity_model->addLog(auth()->user()->id, 'Updated a new tvet school name (\''.$school_name.'\')');
    ...
    public function delete($id)
    {
        try {
            ...
            // Activty Log
            $activity_model = new UserActivityModel(); 
            $activity_model->addLog(auth()->user()->id, 'Deleted a tvet school with the id of \''.$id.'\'');
